...
public class Level1 extends Level {
    ...
    public Level1(double screenWidth, double screenHeight) {
        ...
        Square obstacle4 = new Square(x, 2.5 * screenHeight, 200);
        Square obstacle5 = new Square(x, 3* screenHeight, 40);
        ...
        Shield shield1 = new Shield(screenWidth / 2, 1 * screenHeight);
